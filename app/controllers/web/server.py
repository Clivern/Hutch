...
class ViewServer(View, Controller):
    ...
    template_name = 'templates/server.view_one.html'
...
class ViewServers(View, Controller):
    ...
    template_name = 'templates/server.view_many.html'
...
class CreateServer(View, Controller):
    ...
    template_name = 'templates/server.create.html'
...
class UpdateServer(View, Controller):
    ...
    template_name = 'templates/server.update.html'
